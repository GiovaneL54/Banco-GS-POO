...
print("Sistema bancario otimizado com classes")
...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo:
            print("\n!!!! Erro !!! Voce nao tem saldo suficiente!")
...
class ContaC(Conta):
    ...
    def sacar(self,valor):
        ...
        if excedeu_limite:
            print("\n Erro! Valor informado excedeu o limite!")
...
def criar_cliente(clientes):
    ...
    endereco = input("Informe o endereco (logradouro, nro - cidade/sigla estado):")
...
def criar_conta(numero_conta, clientes, contas):
    ...
    conta = ContaC.nova_conta(cliente = cliente, numero = numero_conta)
    contas.append(conta)
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
            ...
            print("\n Operacao invalida! por favor selecione a  operacao desejada! ")
